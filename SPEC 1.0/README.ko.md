...
> **📦 [SPEC 2.0](../SPEC%202.0/README.ko.md)으로 대체되었습니다**
> 1.0은 이미 1.0으로 운영 중인 프로젝트를 위해 그대로 둡니다. 새 프로젝트는 2.0에서 시작하세요 — 1.0에서 쓰이지 않던 부분을 걷어내고, 재생성 가능한 메타 인덱스를 더한 재설계입니다. [달라진 점 보기](../SPEC%202.0/README.ko.md#-10에서-달라진-점)
