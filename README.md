...
**Version: v1.3.11** (2026-04-24, prototype)
...
| [05.ELEMENT_FORMAT](05.ELEMENT_FORMAT.md) | Map/WayPoint/LOADSTAR_INIT 포맷, TECH_SPEC 아카이브, RECURRING 항목 규약 |
| [06.CLI_SPEC](06.CLI_SPEC.md) | CLI 명령어 명세 (`init`, `show`, `todo`, `log`, `validate`) |
